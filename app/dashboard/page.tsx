    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">{t("Cargando dashboard ...")}</p>
        </div>
      </div>
    )
  }
      ...
      <div className="flex-1 ml-64">
        ...
        <main className="p-6">
          <div className="max-w-7xl mx-auto">
            <div className="mb-6">
              <h1 className="text-2xl font-bold text-gray-900">{t("myRegisteredWastes")}</h1>
              <p className="text-gray-600">{t("manageWastes")}</p>
            </div>
